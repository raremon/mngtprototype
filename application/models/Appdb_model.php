...
class Appdb_model extends CI_Model
{
	private $table = 'tbappdb';
	...
	// C R E A T E
	public function save_Appdb($data)
	{
	...
	// U P D A T E
	public function update_Appdb($data,$where)
	{
		$this->db->where($where);
	...
	// R E A D
	public function getAppdb($where=null,$orwhere=null){
