...
class Appexec_model extends CI_Model
{
	private $table = 'tbappexec';
	...
	// C R E A T E
	public function save_Appexec($data)
	{
	...
	// U P D A T E
	public function update_Appexec($data,$where)
	{
		$this->db->where($where);
	...
	// R E A D
	public function getAppexec($where=null,$orwhere=null){
