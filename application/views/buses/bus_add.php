        ...
        <div class="col-md-12">
          ...
          <?php echo form_open('welcome', array('id'=>'bus')); ?>
            ...
            <div class="form-group">
              ...
              <input type="text" name="bus_name" class="form-control" placeholder="Enter Bus Name"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea name="bus_desc" class="form-control" cols="30" rows="7" placeholder="Enter Short Description"></textarea>
            </div>
            <div class="form-group">
