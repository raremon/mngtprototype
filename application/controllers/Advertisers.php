...
class Advertisers extends MY_Controller {
	...
	{
		$validate = array (
			array('field'=>'advertiser_name','label'=>'Company Name','rules'=>'trim|required|is_unique[advertisers.advertiser_name]|min_length[2]','errors' => array('required' => 'You must enter your %s.',),),
			array('field'=>'advertiser_address','label'=>'Company Address','rules'=>'trim|required|is_unique[advertisers.advertiser_address]|min_length[8]','errors' => array('required' => 'You must enter a %s.',),),
			array('field'=>'advertiser_contact','label'=>'Contact Information','rules'=>'trim|required|is_unique[advertisers.advertiser_contact]|min_length[5]','errors' => array('required' => 'You must enter your company\'s %s.',),),
			array('field'=>'advertiser_email','label'=>'Email Address','rules'=>'trim|required|is_unique[advertisers.advertiser_email]|valid_email|min_length[10]','errors' => array('required' => 'You must enter an %s.',),),
			array('field'=>'advertiser_website','label'=>'Company Website','rules'=>'trim|required|is_unique[advertisers.advertiser_website]|valid_url|min_length[9]','errors' => array('required' => 'You must enter the Website of your Company.',),),
			array('field'=>'advertiser_image','label'=>'Company Logo','rules'=>'trim|required|is_unique[advertisers.advertiser_image]','errors' => array('required' => 'Please upload your %s.',),),
		);
