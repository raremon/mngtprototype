...
//                                    '<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block" onclick="fare_matrix('."'".$rows['fare_id']."'".')">Fare Matrix</a>'.
                                    '<a href="'.site_url('Stops?id='.$route['route_id']).'" class="btn btn-warning btn-sm btn-block" )">Manage Stops</a>'.
                                    '<a href="javascript:void(0)" class="btn btn-info btn-sm btn-block" onclick="edit_stop('."'".$rows['fare_id']."'".')">Edit</a>'.
                                    '<a href="javascript:void(0)" class="btn btn-danger btn-sm btn-block" onclick="delete_stop('."'".$rows['fare_id']."'".')">Delete</a>'
				)
			);
			$ctr += 1;
		}
